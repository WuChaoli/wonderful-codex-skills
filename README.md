...
|---|---|---|
| Codex Tools | Codex 配置、网络、环境、诊断与维护 | [`fix-codex-retry-loop`](plugins/fix-codex-retry-loop/README.md), [`publish-codex-skill`](plugins/publish-codex-skill/README.md) |
...
- PowerShell 7 (`pwsh`) for `fix-codex-retry-loop`
